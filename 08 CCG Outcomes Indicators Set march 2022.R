# R Script: 08 CCG Outcomes Indicators Set maps march 2022.R
library(sf)
library(here)
library(dplyr)
library(ggplot2)
...
# From the above website  we choose to download the Excel zipped files (get path using inspect elements):
